...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'polls_choice', (
            ...
            ('votes', self.gf('django.db.models.fields.IntegerField')(default=200)),
        ))
    ...
    models = {
        ...
        u'polls.choice': {
            ...
            'votes': ('django.db.models.fields.IntegerField', [], {'default': '200'})
        },
        u'polls.poll': {
            'Meta': {'ordering': "(u'_order',)", 'object_name': 'Poll', '_ormbases': [u'pages.Page']},
